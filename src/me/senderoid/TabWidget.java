...
//		tabHost.setBackgroundColor(Color.argb(150, 22, 70, 150)); 
		...
		spec = tabHost.newTabSpec(mates).setIndicator(null,
				res.getDrawable(R.drawable.home_tab)).setContent(intent);
		tabHost.addTab(spec);

		// 团队号外
		intent = new Intent().setClass(this, IteamerActivity2.class);
		String news = this.getResources().getString(R.string.news);
		spec = tabHost.newTabSpec(news).setIndicator(null,
				res.getDrawable(R.drawable.edit_tab)).setContent(intent);
		tabHost.addTab(spec);
		// 会议提醒
		intent = new Intent().setClass(this, IteamerActivity3.class);
		String meeting = this.getResources().getString(R.string.meeting);
		spec = tabHost.newTabSpec(meeting).setIndicator(null,
				res.getDrawable(R.drawable.help_tab)).setContent(intent);
		tabHost.addTab(spec);
		// 队友身影
		intent = new Intent().setClass(this, IteamerActivity4.class);
		String location = this.getResources().getString(R.string.location);
		spec = tabHost.newTabSpec(location).setIndicator(null,
